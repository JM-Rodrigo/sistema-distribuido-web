                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-7">
                        ...
                        <?php
                            ...
                            WHERE
                                ventacalzado.IdVentaCalzado = '$idVenta'";
                        ...
                        ?>
                                ...
                                <form action="funciones/update-venta.php" method="POST" id="contactForm" data-sb-form-api-token="API_TOKEN">
                                        ...
                                        <label class="control-label mt-4" style="color: rgb(0, 0, 0); font-size: 140%;">Codigo</label>
                                            <select class="form-select mt-4" style="color: rgb(0, 0, 0); font-size: 140%;" name="cmbCodigo" id="codigo">
                                                <option><?php echo $venta['Codigo'];?></option>
                                                <?php
                                                    include("funciones/conexion.php");
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="txtPrecio" type="number" step="" minlength="1"  maxlength="10" placeholder="Rellena el campo" data-sb-validations="required" value="<?php echo $venta['PrecioVenta'];?>" />
